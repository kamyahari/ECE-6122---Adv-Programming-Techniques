...
Objective:
Chess component class definition file. Adapted from Lab3 solution
*/
...
// Inputs: None
// Output: None
void chessComponent::setupTexture(GLuint& TextureID) const
{
...
// Inputs: None
// Output: None
void chessComponent::renderMesh() const
{
...
// Inputs: None
// Output: None
glm::mat4 chessComponent::genModelMatrix(const tPosition& cTPosition) const
{
...
// Inputs: None
// Output: ID
std::string chessComponent::getComponentID() const
{
    return cName;
}
